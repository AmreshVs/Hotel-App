    ...
    <Card style={styles.cardContainer}>
      ...
      <View style={styles.skContainer}>
        <SkeletonContent
          ...
          isLoading={true}
          animationType="pulse"
          layout={[styles.hotelImgPlaceholder, styles.textPlaceholder]}
        />
        <SkeletonContent
      ...
      <View style={styles.skContainer}>
        <SkeletonContent
          ...
          isLoading={true}
          animationType="pulse"
          layout={[styles.hotelImgPlaceholder1]}
        />
        <SkeletonContent
          containerStyle={styles.placeholderContainer2}
          isLoading={true}
          animationType="pulse"
          layout={[styles.reviewName, styles.postedon]}
        />
      </View>
      <SkeletonContent
