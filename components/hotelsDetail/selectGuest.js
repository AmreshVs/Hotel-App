...
const SelectGuest = props => {
  ...
  const setValue = value => {
    ...
    setTimeout(function() {
      props.addGuests({
        room: props.roomNum,
        guests: {adult: value, children: btnCIndex},
      });
    }, 100);
  };
  ...
  const setCValue = value => {
    ...
    setTimeout(function() {
      props.addGuests({
        room: props.roomNum,
        guests: {adult: btnIndex, children: value},
      });
    }, 100);
  };
  ...
  return (
    <Card style={styles.room}>
      <View style={styles.cardHeader}>
        ...
        <View>
          <Text style={styles.roomHeading}>
            Adults {btnIndex} {btnCIndex !== 0 ? ', Children ' + btnCIndex : ''}
          </Text>
        </View>
      </View>
      <View style={styles.container}>
        <View style={styles.spaceBetween}>
          ...
          <View>
            <ButtonGroup>
              <Button
                style={btnIndex === 1 ? styles.btnSelected : {}}
                onPress={() => setValue(1)}>
                1
              </Button>
              <Button
                style={btnIndex === 2 ? styles.btnSelected : {}}
                onPress={() => setValue(2)}>
                2
              </Button>
              <Button
                style={btnIndex === 3 ? styles.btnSelected : {}}
                onPress={() => setValue(3)}>
                3
              </Button>
            </ButtonGroup>
      ...
      <View style={styles.container}>
        <View style={styles.spaceBetween}>
          ...
          <View>
            <ButtonGroup>
              <Button
                style={btnCIndex === 0 ? styles.btnSelected : {}}
                onPress={() => setCValue(0)}>
                0
              </Button>
              <Button
                style={btnCIndex === 1 ? styles.btnSelected : {}}
                onPress={() => setCValue(1)}>
                1
              </Button>
              <Button
                style={btnCIndex === 2 ? styles.btnSelected : {}}
                onPress={() => setCValue(2)}>
                2
              </Button>
              <Button
                style={btnCIndex === 3 ? styles.btnSelected : {}}
                onPress={() => setCValue(3)}>
                3
              </Button>
            </ButtonGroup>
      ...
      <Text style={styles.error}>
        {(btnIndex === 2 && btnCIndex === 3) ||
        (btnIndex === 3 && btnCIndex === 2)
          ? "Cannot accomodate more than 4 guest's"
          : ''}
      </Text>
      {props.roomNum > 1 ? (
        <Button
