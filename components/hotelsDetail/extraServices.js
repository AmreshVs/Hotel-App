...
const ExtraServices = props => {
  ...
  const countChange = type => {
    ...
    if (type === 'add' && checkArr[props.id].qty > 0) {
      ...
      props.addServices({
        id: props.id,
        serviceId: checkArr[props.id].service_id,
        qty: checkArr[props.id].qty,
      });
      setTimeout(function() {
        if (props.hotelDetail.serviceChecked.includes(props.id)) {
          props.LoadPrices(
    ...
    return (
      <View style={styles.counterContainer}>
        ...
        <Text style={styles.count}>
          {props.hotelDetail.services[props.id] !== undefined
            ? props.hotelDetail.services[props.id].qty
            : 1}
        </Text>
    ...
    <View style={styles.cardContainer}>
      ...
      <View style={styles.quantityText}>
        ...
        <View style={styles.checkText}>
          ...
          <CheckBox
            checked={
              props.hotelDetail.serviceChecked.includes(props.id) ? true : false
            }
