...
const LoginScreen = props => {
  const items = [
    {
      uri:
        'http://pandadev.amreshrepos.ml/medias/room/medium/7/christopher-jolly-616571-unsplash.jpg',
    },
    {
      uri:
        'http://pandadev.amreshrepos.ml/medias/room/medium/10/armin-djuhic-609206-unsplash.jpg',
    },
    {
      uri:
        'http://pandadev.amreshrepos.ml/medias/room/medium/9/rhema-kallianpur-275251-unsplash.jpg',
    },
  ];
  ...
  const renderIcon = style => <Icon {...style} name="phone-call-outline" />;
