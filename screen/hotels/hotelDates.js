...
const HotelDates = props => {
  ...
  const [range, setRange] = React.useState({
    startDate: props.hotelDetail.dates.startDate,
    endDate: props.hotelDetail.dates.endDate,
  });
    ...
    <SafeAreaView>
      <TabView
        ...
        <Tab title="Guests" style={styles.title}>
          <ScrollView
            style={[styles.tabContainer, styles.guests]}
              ...
              if (props.hotelDetail.rooms[item] !== undefined) {
                return (
                  <SelectGuest
                    key={item}
                    roomNum={item}
                    adult={props.hotelDetail.rooms[item].adult}
                    children={props.hotelDetail.rooms[item].children}
      ...
      <Button style={styles.button} onPress={ClosePage} status="primary">
        Confirm
      </Button>
    </SafeAreaView>
  );
